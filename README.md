...
The date information from the ride data was intitally imported as strings. The string object containing date informationhad to be coverted to Panda datetime objects
...
And the pivot table was reample to aggegate the fare values in the pivot table by week

* per_day_type_total_fare_pt = per_day_type_total_fare_pt.resample("w")

The chart was generated using th plot method on the Pandas pivot table object and using the object oriented interfact to Matplotlab plot api
